...
class ClipMatcher(SetCriterion):
    ...
    def match_for_single_frame(self, outputs: dict):
        ...
        pred_refers_i = track_instances.pred_refers # predicted refer scores of i-th image
        ...
        unmatched_outputs = {
            ...
            'pred_refers': track_instances.pred_refers[unmatched_track_idxes].unsqueeze(0)
        }
...
class TransRMOT(nn.Module):
    ...
    def _generate_empty_tracks(self):
        ...
        track_instances.ref_pts = self.transformer.reference_points(self.query_embed.weight[:, :dim // 2]) # first hidden_dim for init point prediction
