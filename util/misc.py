...
def init_distributed_mode(args):
    if 'RANK' in os.environ and 'WORLD_SIZE' in os.environ:
        ...
        # print("{},{},{}".format(args.rank,args.world_size,args.gpu))
        args.dist_url = 'env://'
        os.environ['LOCAL_SIZE'] = str(torch.cuda.device_count())
        # print("当前可用的gpu数为：{}".format(torch.cuda.device_count()))
        # print("gpu名字为:{}".format(torch.cuda.get_device_name(0)))
        # print("正在使用的gpu编号为：{}".format(torch.cuda.current_device()))
